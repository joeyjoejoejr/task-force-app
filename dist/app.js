...
/***/ function(module, exports, __webpack_require__) {
	...
	var TaskForceApp = (function (_React$Component) {
	  _inherits(TaskForceApp, _React$Component);

	  function TaskForceApp() {
	    _classCallCheck(this, TaskForceApp);

	    _get(Object.getPrototypeOf(TaskForceApp.prototype), "constructor", this).apply(this, arguments);
	  }

	  _createClass(TaskForceApp, [{
	    key: "render",
	...
	exports.TaskForceApp = TaskForceApp;

	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/joe/development/webapps/task-force-app/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TaskForceApp.js" + ": " + err.message); } }); } } })(); }
